...
Bind arbitrary element properties (not just attributes) with the property name as the attribute:
...
See [Hypermedia actions](/guide/hypermedia) for action options.
