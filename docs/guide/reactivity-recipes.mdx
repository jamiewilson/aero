...
When a parent and child both edit the same value, use [live props](/guide/reactivity/live-props):
...
Hypermedia swaps and manual `innerHTML` need [adopt](/guide/reactivity/adopt) so bindings attach to new nodes. When hypermedia and reactivity are both on, adoption after swaps is automatic.
