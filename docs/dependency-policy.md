...
For product-level principles that include “stay aligned with Vite / modern JS tooling,” see [\_reference/aero-principles-and-goals.md](../_reference/guides/aero-principles-and-goals.md).
