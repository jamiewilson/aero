...
<CardGroup cols={2}>
  ...
  <Card title="Optional reactivity" icon="sparkles">
    Opt into `<script is:state>`, bindings, and live props — no Virtual DOM, no mandatory runtime.
  </Card>
...
| `@aero-js/reactivity` | Signal store, bindings, and adopt API (used via core when enabled)  |
...
<CardGroup cols={2}>
	...
	<Card title="Reactivity" icon="sparkles" href="/guide/reactivity">
