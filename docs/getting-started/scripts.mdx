...
| `<script is:state>`    | Yes     | End of `<body>` | Browser; reactive bindings (opt-in)   |
...
See [Reactivity](/getting-started/reactivity) for bindings, structural directives, and reactive props.
