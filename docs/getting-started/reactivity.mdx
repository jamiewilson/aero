...
**Hydration:** Owned collection values serialize into `<script type="aero/state">`. Plain objects and arrays round-trip as JSON; `Map` and `Set` use `__aero` markers in the payload.
