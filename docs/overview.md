...
- **create-aero** — Scaffold from minimal or kitchen-sink template. See [monorepo-and-packages.md](monorepo-and-packages.md#packagesstart-create-aero).
...
- **Props** — Attributes or `data-props`; read via `aero.props`. [props_guide.md](props_guide.md)
- **Conditionals and loops** — `if` / `else-if` / `else`, `data-each` with `{ }` expressions.
...
- **Redirects and middleware** — Config redirects and request-time middleware (dev). Root [README](../README.md#configuration).
