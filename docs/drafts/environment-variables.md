...
| Variable                            | Purpose                                                                                                                                                                                                                                        |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AERO_INCREMENTAL`                  | When `1`, `true`, or `yes`, enables incremental static prerender, manifest caching, and (with content) on-disk cache for collection parsing. Same effect as `aero build --incremental`. |
