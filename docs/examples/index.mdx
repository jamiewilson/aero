...
<CardGroup cols={2}>
	...
	<Card title="Create minimal template" icon="rocket" href="/quickstart">
		`pnpm create @aero-js my-app` scaffolds the minimal template by default.
	</Card>
	<Card title="Create fullstack template" icon="server" href="/quickstart">
		Add `--template fullstack` for Nitro and API routes pre-wired. See the Quick Start for the exact
		command.
	</Card>
</CardGroup>
