...
Aero adds template diagnostics and TypeScript/JavaScript support for live script blocks.
...
- **Formatting defaults** — Recommends the Prettier extension and sets `[aero]` files to format with Prettier (see [Formatting](/tooling/formatting)).
