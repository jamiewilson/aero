...
- **Formatting** — Recommends the Prettier extension for Aero HTML templates (see [Formatting](/tooling/formatting)). Also contributes Prettier config schema so `aero*` options autocomplete and show hover docs in `.prettierrc` / `.prettierrc.json`.
