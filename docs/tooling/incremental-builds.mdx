...
There are two ways to opt in — pick whichever fits your workflow:
...
<Warning>
	Dynamic routes opt your project out of whole-phase and partial prerender skipping. If build speed
	matters, consider whether all parameterized pages need to be dynamic.
</Warning>
